    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>Chiriroc</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Chiricoc</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                    Jeremias Chiricoc - Desarrollando Software
                      <small>https://www.facebook.com/jeremias.chiricoc</small>
                    </p>
                  </li>
